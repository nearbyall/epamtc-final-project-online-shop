...
<main class="content">
    ...
    <div class="form-wrapper" id="component-form">
        ...
        <form class="fieldset" method="post" action="Controller?action=addProductCategory" enctype="multipart/form-data">
            ...
            <legend class="title">
                <fmt:message bundle="${locale}" key="admin.product.cattegory.addition.btn"/>
            </legend>
            
            <label class="product-select_wrapper">
            	<fmt:message bundle="${locale}" key="admin.product.category.addition.image"/>
            ...
            <label class="product-select_wrapper">
            	<button class="submit" name="action" value="addProductCategory">
                    <span><fmt:message bundle="${locale}" key="admin.product.cattegory.addition.btn"/></span>
                </button>
            </label>
