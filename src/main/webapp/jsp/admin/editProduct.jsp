...
<main class="content">
	...
	<div class="form-wrapper" id="component-form">
		...
		<form class="fieldset" method="post" action="Controller?action=editProduct" enctype="multipart/form-data">
        
			<input type="hidden" name="redirectPageCommand" value="openMainPage">
			<input type="hidden" name="productId" value="${productId}"/>
        
			<legend class="title">
				<fmt:message bundle="${locale}" key="admin.editProduct"/>
			</legend>
			...
			<label class="product-select_wrapper">
				<button class="submit" name="action" value="editProduct">
					<span><fmt:message bundle="${locale}" key="admin.btn.editProduct"/></span>
				</button>
			</label>
